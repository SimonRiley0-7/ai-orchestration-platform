    ...
    <div className={cn('p-4 advocate-card flex flex-col gap-4', className)}>
      ...
      <div className="flex flex-row justify-between items-start">
        ...
        <div className="text-right">
          <span className="score-display text-finguard-green">
            ...
            <div className="flex flex-col gap-2">
              ...
              <ul className="flex flex-col gap-2">
                {result.arguments.map((arg, i) => (
                  <li key={i} className="flex gap-2 items-start text-sm border-l-2 border-finguard-green pl-2 bg-finguard-green/5 py-1">
